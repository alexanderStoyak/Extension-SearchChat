            ...
            <div class="ProfileModalInfoHeadline" style="padding: 10px;">
                <span style="font-size: 13px; display: inline; gap: 5px; font-weight: 600; align-items: center;">
                    ...
                    <span style="color: #FD324A;"> 
                        Для использования расширения необходима авторизация, которая будет выполняться путем получения вашего токена ВКонтакте с помощью приложения «<a class="link" target="_blank" href="${services.urlByGetToken}">Kate Mobile</a>».
                    </span>
